package com.agro.inventory.base
...
open class BaseViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val accesUsername = accessManager.accessUsername
    ...
    inline fun <T> accessUsername(crossinline result: (accessUsername: String) -> Flow<Result<T>>) =
        accesUsername.flatMapLatest { username -> result.invoke(username) }
