...
import com.agro.inventory.BuildConfig
import com.agro.inventory.data.preferences.AccessManager
import com.agro.inventory.ui.main.MainActivity.Companion.LOGIN_ATTEMPT_KEY
import com.agro.inventory.util.Const.NETWORK.EQUALS
import com.agro.inventory.util.Const.NETWORK.SESSION_ID
...
object NetworkModule {
    ...
    const val AGRO_FORESTRY_ACCESS_KEY = "agroforestry"

    @Provides
    @Named(AGRO_FORESTRY_ACCESS_KEY)
    ...
    fun provideOkHttpCallback(
        ...
        .addInterceptor{
            val authorisedRequest : Request = it.request().newBuilder()
                .addHeader(
                  BuildConfig.ACCEPT_KEY,
                    BuildConfig.ACCEPT_VALUE)
                .addHeader(
                    BuildConfig.APPLICATION_KEY_NAME,
                   BuildConfig.APPLICATION_KEY_VALUE_NAME)
                .apply {
                    runBlocking {
    ...
    fun provideRetrofit(
        ...
        @Named(AGRO_FORESTRY_ACCESS_KEY) baseURL: String
