package com.agro.inventory.ui.main.imagepicker
...
import com.agro.inventory.util.DialogStyle
import com.agro.inventory.util.dialog
...
class   ImagePickerActivity : AppCompatActivity() {
    ...
    private fun cropImage(sourceUri: Uri) {
        ...
        options.setToolbarColor(ContextCompat.getColor(this, R.color.mariner))
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.mariner))
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.purple_200))
